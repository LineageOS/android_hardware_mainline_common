...
- The reference/example HAL implementation for the domain, under
  `hardware/interfaces/<domain>/aidl/default/` in the AOSP tree (available at
  `/android/LineageOS/24/hardware/interfaces/<domain>/aidl/default/` if you
  need to look one up).
